...
namespace Strave {
	...
	private:
		...
		public:
			...
			inline unsigned int GetSize(void) const { return m_Container.size(); }
			inline std::vector<Type*>& GetElements(void) { return m_Container; }
	...
	public:
		...
		template<> inline VectorContainer<Player2D>& GetContainer(void) { return m_PlayerContainer; }
		template<> inline VectorContainer<GameObject2D>& GetContainer(void) { return m_GameObjectContainer; }
		template<> inline VectorContainer<RigidBody2D>& GetContainer(void) { return m_RigidBodyContainer; }
		template<> inline VectorContainer<GUI::UserInterface>& GetContainer(void) { return m_UIContainer; }
