...
// Definition of Interface mess
#define UINT_BEGINING		0
#define INIT_DEF_VIEW_STATE	1
#define NO_MARGINS		{ 0.0f, 0.0f }
#define VECTOR_BEGINING		UINT_BEGINING

// Definition of Cell mess
#define ELEMENT_MARGINS_PERCENTAGE	85.0f
...
namespace Strave {
	...
	namespace GUI {
		...
		class UserInterface abstract : public GameObject2D {
		private:
			friend Application;
