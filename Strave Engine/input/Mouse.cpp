...
namespace Strave {
	...
	bool Mouse::Hover(const GUI::UserInterface& obj) {
		...
		if (t_MousePosition.x >= obj.GetSpritePosition().x &&
			t_MousePosition.y >= obj.GetSpritePosition().y) {

			if (t_MousePosition.x <= obj.GetSpritePosition().x + obj.GetRectSpriteSize().x &&
				t_MousePosition.y <= obj.GetSpritePosition().y + obj.GetRectSpriteSize().y) {
	...
	bool Mouse::Hover(const GameObject2D& obj) {
		...
		if (t_TranslatedPosition.x >= obj.GetSpritePosition().x &&
			t_TranslatedPosition.y >= obj.GetSpritePosition().y) {

			if (t_TranslatedPosition.x <= obj.GetSpritePosition().x + obj.GetSpriteSize().x &&
				t_TranslatedPosition.y <= obj.GetSpritePosition().y + obj.GetSpriteSize().y) {
	...
	bool Mouse::Drag(GameObject2D& obj) {
		...
		t_OldObjectPosition = obj.GetSpritePosition();
