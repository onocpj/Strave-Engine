	...
	namespace Collider {
		...
		bool PixelPerfectTest(const sf::Sprite& Object1, const sf::Sprite& Object2, sf::Uint8 AlphaLimit) {
			...
			if (Object1.getGlobalBounds().intersects(Object2.getGlobalBounds(), Intersection)) {
				...
				sf::Uint8* mask1 = s_Bitmasks.GetMask(Object1.getTexture());
				sf::Uint8* mask2 = s_Bitmasks.GetMask(Object2.getTexture());
				...
				for (int i = (int)Intersection.left; i < Intersection.left + Intersection.width; i++) {
					for (int j = (int)Intersection.top; j < Intersection.top + Intersection.height; j++) {
						...
						if (o1v.x > 0 && o1v.y > 0 && o2v.x > 0 && o2v.y > 0 &&
							...
							if (s_Bitmasks.GetPixel(mask1, Object1.getTexture(), (int)(o1v.x) + O1SubRect.left, (int)(o1v.y) + O1SubRect.top) > AlphaLimit &&
								s_Bitmasks.GetPixel(mask2, Object2.getTexture(), (int)(o2v.x) + O2SubRect.left, (int)(o2v.y) + O2SubRect.top) > AlphaLimit
								)
							{
								return true;
							}
		...
		bool CreateTextureAndBitmask(sf::Texture& LoadInto, const std::string& Filename) {
			...
			s_Bitmasks.CreateMask(&LoadInto, img);
		...
		float CollidingResistance(float collisionAngle) {
			return Math::Round(sin(Math::DegreesToRadians(DEFAULT_COLLISION_ANGLE)), 2);
		}
